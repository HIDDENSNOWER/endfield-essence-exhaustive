...
(function (App) {
    ...
    App.constants = {
        ...
        UNACQUIRED_REGION_FILTER_KEY: 'smarttable_unacquired_region_filter', // 未获取统计的地区筛选（数组，null=全部）

        // =========================================================================
        // 二、系列技能与属性定义
        // 数据表结构：14 个系列技能 × 5 个能力值 = 70 列，12 个属性
        // =========================================================================

        // 所有系列技能，每个技能包含名称和其下的能力值列表
        // 能力值固定为 5 个：敏捷、力量、意志、智识、主能力
        ALL_GROUPS: [
        ...
        INTERFACE_COLOR_GROUPS: [
            ...
            },
            {
                ...
                vars: {
                    ...
                    '--border-emphasis': '强调边框（分组分隔）' // 系列技能之间的粗分隔线
                }
            },
            {
                // 功能颜色
            ...
            },
            {
                ...
                name: '表头背景',
                vars: {
                    '--group-header-even-bg': '表头偶数单元格背景', // 表头中偶数系列技能的背景
                    '--group-header-odd-bg': '表头奇数单元格背景'   // 表头中奇数系列技能的背景
                }
            },
            {
                // 表格行背景
        ...
        // 颜色预览表格总单元格数（12 行 × 10 列，仅预览前两个系列技能）
        TOTAL_CELLS: 120,
        ...
        // 能力值列表（每张基质含 3 项能力值）
        SUB_ATTRS: ['敏捷', '力量', '意志', '智识', '主能力'],

        // 地区数据存储键
        REGIONS_STORAGE_KEY: 'smarttable_regions',

        // 默认地区数据（属性 8 个 + 系列技能 8 个）
        DEFAULT_REGIONS: [
            { name: '枢纽区',   rows: ['攻击提升','寒冷伤害提升','终结技充能效率提升','灼热伤害提升','自然伤害提升','法术伤害提升','电磁伤害提升','源石技艺提升'], groups: ['强攻','粉碎','流转','压制','巧技','效益','追袭','迸发'] },
            { name: '源石研究园', rows: ['攻击提升','寒冷伤害提升','终结技充能效率提升','物理伤害提升','自然伤害提升','法术伤害提升','电磁伤害提升','暴击率提升'], groups: ['压制','巧技','切骨','追袭','附术','效益','昂扬','医疗'] },
            { name: '矿脉源区', rows: ['生命提升','寒冷伤害提升','源石技艺提升','物理伤害提升','自然伤害提升','治疗效率提升','灼热伤害提升','暴击率提升'], groups: ['强攻','残暴','夜幕','压制','附术','效益','巧技','迸发'] },
            { name: '供能高地', rows: ['攻击提升','灼热伤害提升','源石技艺提升','生命提升','自然伤害提升','治疗效率提升','物理伤害提升','暴击率提升'], groups: ['追袭','残暴','切骨','粉碎','附术','流转','昂扬','医疗'] },
            { name: '武陵城',   rows: ['攻击提升','寒冷伤害提升','法术伤害提升','生命提升','暴击率提升','治疗效率提升','电磁伤害提升','终结技充能效率提升'], groups: ['强攻','医疗','夜幕','粉碎','切骨','流转','残暴','迸发'] },
            { name: '清波寨',   rows: ['生命提升','寒冷伤害提升','法术伤害提升','物理伤害提升','源石技艺提升','治疗效率提升','电磁伤害提升','终结技充能效率提升'], groups: ['压制','巧技','迸发','粉碎','医疗','夜幕','昂扬','切骨'] },
            { name: '首墩',     rows: ['攻击提升','电磁伤害提升','终结技充能效率提升','物理伤害提升','自然伤害提升','法术伤害提升','灼热伤害提升','暴击率提升'], groups: ['强攻','残暴','流转','追袭','附术','效益','昂扬','夜幕'] },
            { name: '实验园区', rows: ['生命提升','寒冷伤害提升','终结技充能效率提升','灼热伤害提升','自然伤害提升','治疗效率提升','电磁伤害提升','源石技艺提升'], groups: ['压制','残暴','夜幕','粉碎','附术','流转','巧技','切骨'] },
            { name: '藏剑谷',   rows: ['攻击提升','灼热伤害提升','源石技艺提升','生命提升','寒冷伤害提升','治疗效率提升','物理伤害提升','自然伤害提升'], groups: ['强攻','巧技','迸发','追袭','医疗','效益','昂扬','切骨'] },
            { name: '应龙关',   rows: ['攻击提升','寒冷伤害提升','源石技艺提升','物理伤害提升','自然伤害提升','法术伤害提升','电磁伤害提升','暴击率提升'], groups: ['压制','残暴','流转','追袭','附术','效益','巧技','迸发'] },
            { name: '北部禁区', rows: ['生命提升','自然伤害提升','法术伤害提升','物理伤害提升','暴击率提升','治疗效率提升','灼热伤害提升','源石技艺提升'], groups: ['强攻','粉碎','医疗','压制','昂扬','效益','追袭','附术'] },
            { name: '雪松林',   rows: ['攻击提升','电磁伤害提升','法术伤害提升','生命提升','暴击率提升','治疗效率提升','灼热伤害提升','终结技充能效率提升'], groups: ['强攻','残暴','夜幕','粉碎','医疗','流转','昂扬','迸发'] }
        ],
    };
