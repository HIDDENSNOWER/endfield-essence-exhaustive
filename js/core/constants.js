...
(function (App) {
    ...
    App.constants = {
        ...
        // 默认地区数据（副属性 8 个 + 词条 8 个）
        DEFAULT_REGIONS: [
            { name: '枢纽区',   rows: ['攻击提升','寒冷伤害提升','终结技效率提升','灼热伤害提升','自然伤害提升','法术伤害提升','电磁伤害提升','源石技艺提升'], groups: ['强攻','粉碎','流转','压制','巧技','效益','追袭','迸发'] },
            { name: '源石研究园', rows: ['攻击提升','寒冷伤害提升','终结技效率提升','物理伤害提升','自然伤害提升','法术伤害提升','电磁伤害提升','暴击率提升'], groups: ['压制','巧技','切骨','追袭','附术','效益','昂扬','医疗'] },
            ...
            { name: '武陵城',   rows: ['攻击提升','寒冷伤害提升','法术伤害提升','生命提升','暴击率提升','治疗效率提升','电磁伤害提升','终结技效率提升'], groups: ['强攻','医疗','夜幕','粉碎','切骨','流转','残暴','迸发'] },
            { name: '清波寨',   rows: ['生命提升','寒冷伤害提升','法术伤害提升','物理伤害提升','源石技艺提升','治疗效率提升','电磁伤害提升','终结技效率提升'], groups: ['压制','巧技','迸发','粉碎','医疗','夜幕','昂扬','切骨'] },
            { name: '首墩',     rows: ['攻击提升','电磁伤害提升','终结技效率提升','物理伤害提升','自然伤害提升','法术伤害提升','灼热伤害提升','暴击率提升'], groups: ['强攻','残暴','流转','追袭','附术','效益','昂扬','夜幕'] },
            { name: '实验园区', rows: ['生命提升','寒冷伤害提升','终结技效率提升','灼热伤害提升','自然伤害提升','治疗效率提升','电磁伤害提升','源石技艺提升'], groups: ['压制','残暴','夜幕','粉碎','附术','流转','巧技','切骨'] },
            ...
            { name: '雪松林',   rows: ['攻击提升','电磁伤害提升','法术伤害提升','生命提升','暴击率提升','治疗效率提升','灼热伤害提升','终结技效率提升'], groups: ['强攻','残暴','夜幕','粉碎','医疗','流转','昂扬','迸发'] }
        ],
    };
